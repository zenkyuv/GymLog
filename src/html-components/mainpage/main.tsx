	...
	<div>
		...
		<div className="container">
			<ul className="features-items">
				<li className="feature-item">
					<div className="left-icon">
						<img src={featuesFirstIcon} alt="First One" />
					</div>
				...
				<li className="feature-item">
					<div className="left-icon">
						<img src={featuesFirstIcon} alt="second one" />
					</div>
					<div className="right-content">
				...
				<li className="feature-item">
					<div className="left-icon">
						<img src={featuesFirstIcon} alt="third gym training" />
					</div>
					<div className="right-content">
			...
			<ul className="features-items">
				<li className="feature-item">
					<div className="left-icon">
						<img src={featuesFirstIcon} alt="fourth muscle" />
					</div>
					<div className="right-content">
				...
				<li className="feature-item">
					<div className="left-icon">
						<img src={featuesFirstIcon} alt="training fifth" />
					</div>
					<div className="right-content">
						<h4>Yoga Training</h4>
				...
				<li className="feature-item">
					<div className="left-icon">
						<img src={featuesFirstIcon} alt="gym training" />
					</div>
					<div className="right-content">
	...
	<section className="section" id="our-classes">
		...
		<div className="row" id="tabs">
			<ul>
				...
				<li><a href='#tabs-2'><img src="../images/tabs-first-icon.png" alt="" />Second Training Class</a></li>
				<li><a href='#tabs-3'><img src="../images/tabs-first-icon.png" alt="" />Third Training Class</a></li>
				<li><a href='#tabs-4'><img src="../images/tabs-first-icon.png" alt="" />Fourth Training Class</a></li>
